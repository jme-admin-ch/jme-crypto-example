 ...
 * ch.admin.bit.jeap:jeap-crypto-db - [ch.admin.bit.jeap:jeap-crypto-db](https://github.com/jeap-admin-ch/jeap-crypto/tree/main/jeap-crypto-db)
 * ch.admin.bit.jeap:jeap-crypto-s3 - [ch.admin.bit.jeap:jeap-crypto-s3](https://github.com/jeap-admin-ch/jeap-crypto/tree/main/jeap-crypto-s3)
 ...
 * ch.admin.bit.jeap.jme.messagetype.jme:jme-game-review-created-event - [ch.admin.bit.jeap.jme.messagetype.jme:jme-game-review-created-event](https://github.com/jme-admin-ch/jme-message-type-registry/tree/main)
 ...
 * AWS Java SDK :: Services :: AWS KMS - [software.amazon.awssdk:kms](https://aws.amazon.com/sdkforjava)
